...
import com.eyesoreinc.bluetooth.BluetoothService;


@Kroll.module(name="Bluetooth", id="com.eyesoreinc.bluetooth")
public class BluetoothModule extends KrollModule
{
	...
	public ComponentName className = new ComponentName("com.eyesoreinc.bluetooth", "BluetoothModule");
